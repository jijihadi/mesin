...
@section('title','Form Untuk Mengubah Data User')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <h4 class="text-center "><strong>FORM UNTUK MENGUBAH DATA USER</strong></h4> 
                    <br>
                    <br>

                    <form class="form" method= "post" action="/admin/{{$user->id}}/ubahDataUser/update" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group col-md-12">
                            <label for="id_pegawai">ID Pegawai</label>
                            <input type="text" class="form-control @error('id_pegawai') is-invalid @enderror" id="id_pegawai" name="id_pegawai" value="{{ $user->id_pegawai}}">
                                @error('id_pegawai')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <option disable value="">{{ $user->role}}</option>
