        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif -->
                    <h4 class="text-center "><strong>FORM TAMBAH DATA MESIN PRODUKSI <br> CV. SUMBER NIAGA</strong></h4> 
                    <br>
                    <br>

                    <form class="form" method= "POST" action="{{route('tambahMesin.tambah')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group col-md-12">
                            <label for="nama_mesin">Nama Mesin</label>
                            <input type="text" class="form-control @error('nama_mesin') is-invalid @enderror" id="nama_mesin" name="nama_mesin"  value="{{ old('nama_mesin') }}" placeholder="Nama Mesin">
                                @error('nama_mesin')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="date" class="form-control @error('tanggal_pembelian') is-invalid @enderror" id="tanggal_pembelian" name="tanggal_pembelian" value="{{ old('tanggal_pembelian') }}" placeholder="Tanggal Pembelian">
