...
<head>
    ...
    <title>REKAPITULASI DATA PERBAIKAN MESIN PRODUKSI CV. SUMBER NIAGA</title>
        ...
        <div class="col-md-12">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <h4 class="text-center"  align="center"> <strong>REKAPITULASI DATA PERBAIKAN MESIN PRODUKSI CV. SUMBER NIAGA</strong> </h4>
                    ...
                    <table class="static " align="center" rules="all" border="1px" style="width: 95%;">
                            ...
                            <tbody class="tbody table-light text-center" >
                                ...
                                <td class="jdl text-center" scope="row" align="center">{{$hasil->deskripsi_masalah}}</td>
                                ...
                                <td class="waktuPeng text-center" >{{$hasil->created_at->diffInHours($hasil->tanggal_perbaikan)}} Jam</td>
